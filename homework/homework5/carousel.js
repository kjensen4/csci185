...
*/
function showImage() {
    let currentphoto = document.querySelector('.current-photo>img');
...
*/
function forward() {
    idx = (idx + 1) % photos.length     // Increment with wrap
    showImage();
}
...
*/
function back() {
    idx = (idx + photos.length - 1) % photos.length     // Decrement with wrap
    showImage();
}
