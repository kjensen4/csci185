function makeBigger() {
   document.querySelector("header").id = "bigger";
   document.querySelector(".content").id = "bigger";
};

function makeSmaller() {
   document.querySelector("header").id = "smaller";
   document.querySelector(".content").id = "smaller";
};
